...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolov5obb_mydata.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/obb/hyp.finetune_mydata.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--workers', type=int, default=5, help='max dataloader workers (per RANK in DDP mode)')
