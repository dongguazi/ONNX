...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'yolov5obb_dota_demo.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/yolov5m_csl_dotav1.5/weights/best.pt', help='model.pt path(s)')
