...
if __name__ == '__main__':
    ...
    img0 = cv2.imread('\\imags\\20220804163331843.jpg')
    ...
    pred = np.squeeze(pred)  #[11,8400]
    pred = np.transpose(pred, (1, 0))   #[8400,11]
    pred_class = pred[..., 4:]  #[8400,7]
    pred_conf = np.max(pred_class, axis=-1)  #[8400,]
    pred = np.insert(pred, 4, pred_conf, axis=-1)  #[8400,12]
